...
struct AnalyzerPathGenerator
{
                      ...
                      float negativeInfinity)
    {
        ...
        auto width = fftBounds.getWidth() - 7.0;
...
struct PathProducer{
    PathProducer(SingleChannelSampleFifo<TestAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<TestAudioProcessor::BlockType>* leftChannelFifo;
...
juce::Timer{
    ResponseCurveComponent(TestAudioProcessor&);
...
private:
    ...
    using ButtomAttachment = APVTS::ButtonAttachment;
    ButtomAttachment lowcutBypassButtonAttachment,
