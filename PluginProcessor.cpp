...
//    adding sin wave to test analyzer
//    buffer.clear();
//
...
{
    //return new juce::GenericAudioProcessorEditor(*this);// this is to show the nobs
    return new TestAudioProcessorEditor(*this); //this is to the gui
}
...
Coefficients makePeakFilter(const ChainSettings& chainSetting, double sampleRate){
    return juce::dsp::IIR::Coefficients<float>::makePeakFilter(sampleRate, chainSetting.peakFreq, chainSetting.peakQuality, juce::Decibels::decibelsToGain(chainSetting.peakGainInDecibels));
}


void TestAudioProcessor::updatePeakFilter(const ChainSettings &chainsettings){
...
void TestAudioProcessor::updateLowCutFilters(const ChainSettings &chainSettings){
//    lowcut
//    left chain
...
void TestAudioProcessor::updateHighCutFilters(const ChainSettings &chainsettings){
...
void TestAudioProcessor::updateFilters(){
